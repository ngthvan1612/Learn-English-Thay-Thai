...
import { getCurrentUserRole, ROLE_ADMIN } from '../authorization';
...
const items = [
  getItem(<NavLink end to='/admin'>Dashboard</NavLink>, '1', <UserOutlined />),
  getItem(<NavLink end to='/admin/user/staff'>Quản lý nhân viên</NavLink>, '3', <UserOutlined />),
  getItem(<NavLink end to='/admin/user/teacher'>Quản lý giảng viên</NavLink>, '2', <UserOutlined />),
  getItem(<NavLink end to='/admin/user/student'>Quản lý học viên</NavLink>, '4', <UserOutlined />)
];
